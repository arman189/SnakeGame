...
# Game Title
pygame.display.set_caption("SnakeLikeYou")
...
def welcome():
    exit_game = False
    while not exit_game:
        gameWindow.blit(intro,(-250,-80))
        text_screen("Welcome to Snake World", black, 255, 250)
        text_screen("Press Space Bar To Play", black, 255, 290)
        text_screen("Developed By Md Arman Khan", white, -200, 550)
...
def gameloop():
    ...
    while not exit_game:
        if game_over:
            ...
            pygame.draw.circle(gameWindow, red, (food_x, food_y),radius=15)
